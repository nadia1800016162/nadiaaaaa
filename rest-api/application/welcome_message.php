...
<head>
    <meta charset="utf-8">
    <title>Welcome to REST-Server CodeIgniter</title>
...
<div id="container">
    <h1>Welcome to REST-Server CodeIgniter!</h1>
    ...
    <div id="body">
        ...
        <p>If you would like to edit student data page you'll find it located at:</p>
        <code>application/views/siswa.php</code>

        <p>The corresponding controller for this page is found at:</p>
        <code>application/controllers/Siswa.php</code>
